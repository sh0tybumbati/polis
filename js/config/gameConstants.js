...
export const BLDG = {
  ...
  bakery:     { label: '🍞 Bakery',     color: 0xcc9944, cost: { stone: 4, wood: 3 }, size: 2, stores: { flour: 20, bread: 20 } },
  butcher:    { label: '🥩 Butcher',      color: 0xaa4433, cost: { stone: 3, wood: 3 }, size: 2, stores: { meat: 40, sausages: 20, hide: 20 } },
  olive_press:{ label: '🫒 Olive Press', color: 0x667733, cost: { stone: 5, wood: 4 }, size: 2, stores: { olives: 40 } },
  ...
  watchtower: { label: '🗼 Watchtower',        color: 0x7a7060, cost: { stone: 4, wood: 3 }, size: 1, fogRadius: 6, atkRange: 5 * TILE, garrisonRanged: 2, garrisonMelee: 2 },
  gate:       { label: '🚪 Gate',         color: 0xa08858, cost: { stone: 3, wood: 2 }, size: 1 },
  wall:       { label: '🧱 Wall',       color: 0x9a9888, cost: { stone: 2 },          size: 1 },
  carpenter:  { label: '🪚 Carpenter',     color: 0x9a6030, cost: { stone: 4, wood: 6 }, size: 2,
                stores: { planks: 40 } },
  masons:     { label: '🪨 Masons',        color: 0x7a7060, cost: { stone: 8, wood: 3 }, size: 2,

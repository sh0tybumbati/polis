...
export const BLDG = {
  ...
  granary:    { label: '🌾 Granary',       color: 0xcc9933, cost: {},               materialQty: 7,  size: 2,
  ...
  stonepile:  { label: '🧱 Stone Pile',    color: 0x888878, cost: { stone: 3 },                      size: 2, outdoor: true,
                stores: { stone: 50, stones: 80 } },
  farm:       { label: '🚜 Farm',          color: 0x5a9a28, cost: {},               materialQty: 5,  size: 2, outdoor: true, stockMax: 32 },
  garden:     { label: '🌻 Garden',        color: 0x448833, cost: {},               materialQty: 4,  size: 2, outdoor: true, stockMax: 20,
                stores: { olives: 30 } },
  barracks:   { label: '⚔ Barracks',      color: 0x8a6848, cost: { stone: 2 },     materialQty: 6,  size: 2, spawnMs: 18000 },
  archery:    { label: '🏹 Archery Range', color: 0x2a7a4a, cost: { stone: 1 },     materialQty: 6,  size: 2, outdoor: true, spawnMs: 16000 },
  ...
  blacksmith: { label: '🔨 Blacksmith',    color: 0x555566, cost: { stone: 2 },     materialQty: 6,  size: 2,
                stores: { bronzeKit: 10 } },
  mill:       { label: '⚙ Mill',           color: 0xaa9955, cost: { stone: 3 },     materialQty: 4,  size: 2,
                stores: { wheat: 40, flour: 30 } },
  bakery:     { label: '🍞 Bakery',        color: 0xcc9944, cost: { stone: 2 },     materialQty: 5,  size: 2,
  ...
  watchtower: { label: '🗼 Watchtower',    color: 0x7a7060, cost: { stone: 2 },     materialQty: 4,  size: 1, outdoor: true,

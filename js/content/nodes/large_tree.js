export default {
    ...
    draw(gfx, n, alpha) {
        if (n.felled) {
            ...
            gfx.fillStyle(0x5a3318, alpha).fillRect(-4, 0, 8, 14);
            gfx.fillStyle(0x144a0e, alpha).fillCircle(0, -14, 22);
            gfx.fillStyle(0x1a6a12, alpha).fillCircle(-8, -4, 16);
            gfx.fillStyle(0x1a6a12, alpha).fillCircle(8, -4, 16);
            gfx.fillStyle(0x2a8020, alpha).fillCircle(0, -20, 16);
            gfx.fillStyle(0x338a28, alpha).fillCircle(0, -12, 12);
        }
    },
};

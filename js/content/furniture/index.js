...
// Each entry defines what the item looks like, what zone type it contributes to,
// and what job (if any) it provides a slot for.
// craftedAt: the zone type that must exist to craft this item (future use).
...
export const FURNITURE = {
    ...
    'Appliance.Anvil': {
        ...
        craftedAt: null, craftCost: { 'Materials.Metal.Copper.Ingot': 4 },
        desc: 'Forges ingots → kits. Requires Forge in same room.',
    },
};
...
// Map from old building type → the appliance that replaces its core function.
// Used for migration hints and auto-classification of existing saves.
